...
earliest_priority <- numbers %>%
  ...
  select(-priority) # drop uneccessary field
```
...
The effect of this adjustment is shown Figure \@ref(fig:kindadjust) where based on the date of the publication (family date), the kind code is adjusted.
