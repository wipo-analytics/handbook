...
<!---Use the forecast package. See Automatic forecasting with exponential smoothing ETS in R to automate the process of forecasting. But you should run the naive model as well and choose the model with the smallest Mean Standard Erros MSE. See then the arima models etc and walk through step by step. Maybe introduce by what the Loess smoothing is doing?--->
